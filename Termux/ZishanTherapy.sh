...
menu_setup() {
    while true; do
        clear
        echo -e "${C_H}=========================================${C_R}"
        echo -e "${C_T}     TERMUX SETUP MENU - Zishan Therapy  ${C_R}"
        echo -e "${C_H}=========================================${C_R}"
        echo -e " ${C_O}[1]${C_R} Basic Termux Setup"
        echo -e " ${C_O}[2]${C_R} Install Platform Tools"
        echo -e " ${C_O}[3]${C_R} Termux Setup Storage"
        echo -e " ${C_O}[4]${C_R} MiUnlockTool Setup & Open"
        echo -e "${C_H}-----------------------------------------${C_R}"
...
menu_download() {
    while true; do
        clear
        echo -e "${C_H}=========================================${C_R}"
        echo -e "${C_T}      DOWNLOAD & INSTALL MENU - ZT       ${C_R}"
        echo -e "${C_H}=========================================${C_R}"
        echo -e " ${C_O}[1]${C_R} Install Magisk Manager (APK)"
        echo -e " ${C_O}[2]${C_R} Install Kitsune Mask (APK)"
        echo -e " ${C_O}[3]${C_R} Install Root Checker (APK)"
...
while true; do
    ...
    echo -e "${C_H}=========================================${C_R}"
    echo -e " ${C_O}[1]${C_R} Termux Setup Menu"
    echo -e " ${C_O}[2]${C_R} Download & Install Menu"
    echo -e " ${C_O}[3]${C_R} ADB Menu"
    echo -e " ${C_O}[4]${C_R} Fastboot Menu"
    echo -e "${C_H}-----------------------------------------${C_R}"
    echo -e " ${C_E}[0]${C_R} Exit Tool"
    echo -e "${C_H}=========================================${C_R}"
    echo -ne "${C_O}Enter your choice:${C_R} "
