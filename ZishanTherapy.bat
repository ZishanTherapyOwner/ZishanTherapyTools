...
echo  %C_O%[3]%C_R% Fastboot Menu (Organized)
...
echo %C_H%=========================================%C_R%
echo  %C_O%[1]%C_R% Device Info ^& Status
echo  %C_O%[2]%C_R% Reboot Options
echo  %C_O%[3]%C_R% Flashing Menu (Normal / Non-A/B)
echo  %C_O%[4]%C_R% Flashing Menu (A/B Slots)
echo  %C_E%[5]%C_R% Wipe ^& Erase Menu
echo %C_H%-----------------------------------------%C_R%
echo  %C_W%[6]%C_R% Bootloader Unlock (flashing unlock)
echo %C_H%-----------------------------------------%C_R%
echo  %C_W%[S]%C_R% Start Scrcpy Mirroring
echo %C_H%-----------------------------------------%C_R%
echo  %C_E%[99]%C_R% Back to Main Menu
echo  %C_E%[0]%C_R% Exit Tool
echo %C_H%=========================================%C_R%
set /p choice="%C_O%Select Category:%C_R% "

if "%choice%"=="1" goto FbInfoMenu
if "%choice%"=="2" goto FbRebootMenu
if "%choice%"=="3" goto FbFlashNormMenu
if "%choice%"=="4" goto FbFlashABMenu
if "%choice%"=="5" goto FbWipeMenu
if "%choice%"=="6" goto FbOptUnlock
...
:: --- Sub-Menu: Device Info ---
:FbInfoMenu
cls
echo %C_H%=========================================%C_R%
echo %C_T%        DEVICE INFO ^& STATUS MENU        %C_R%
echo %C_H%=========================================%C_R%
echo  %C_O%[1]%C_R% Check Fastboot Devices
echo  %C_O%[2]%C_R% Get Product Name (getvar product)
echo  %C_O%[3]%C_R% Get Device Info (oem device-info)
echo  %C_O%[4]%C_R% Check Bootloader Status (Unlock State)
echo  %C_O%[5]%C_R% Check Current Slot (A/B)
echo  %C_O%[6]%C_R% Get All Variables (getvar all)
echo %C_H%-----------------------------------------%C_R%
echo  %C_E%[99]%C_R% Back to Fastboot Menu
echo %C_H%=========================================%C_R%
set /p info_choice="%C_O%Enter your choice:%C_R% "

if "%info_choice%"=="1" goto FbOptInfo1
if "%info_choice%"=="2" goto FbOptInfo2
if "%info_choice%"=="3" goto FbOptInfo3
if "%info_choice%"=="4" goto FbOptInfo4
if "%info_choice%"=="5" goto FbOptInfo5
if "%info_choice%"=="6" goto FbOptInfo6
if "%info_choice%"=="99" goto FastbootMenu
goto FbInfoMenu
...
if %errorlevel% equ 124 echo %C_E%[!] Error: Connection timed out!%C_R%
if %errorlevel% equ 1 echo %C_E%[!] Error: No fastboot device detected!%C_R%
pause & goto FbInfoMenu
...
if not exist "%FASTBOOT%" goto MissingTools
cls
echo %C_I%[*] Method 1 (Standard):%C_R%
"%FASTBOOT%" getvar unlocked 2>&1 | findstr /i "unlocked"
echo %C_I%[*] Method 2 (Secure boot):%C_R%
"%FASTBOOT%" getvar secure 2>&1 | findstr /i "secure"
echo %C_I%[*] Method 3 (Xiaomi/OEM):%C_R%
"%FASTBOOT%" oem device-info 2>&1 | findstr /i "unlock"
echo.
echo %C_W%[!] Note: If any method says "true/yes" for unlocked, it is UNLOCKED.%C_R%
pause & goto FbInfoMenu

:FbOptInfo5
if not exist "%FASTBOOT%" goto MissingTools
cls
echo %C_I%[*] Checking current slot...%C_R%
...
if not exist "%FASTBOOT%" goto MissingTools
cls
echo %C_I%[*] Getting all variables...%C_R%
"%FASTBOOT%" getvar all
pause & goto FbInfoMenu


:: --- Sub-Menu: Reboot Options ---
:FbRebootMenu
cls
echo %C_H%=========================================%C_R%
echo %C_T%             REBOOT OPTIONS             %C_R%
echo %C_H%=========================================%C_R%
echo  %C_O%[1]%C_R% Reboot to System
echo  %C_O%[2]%C_R% Reboot to Recovery
echo  %C_O%[3]%C_R% Reboot to Fastbootd (User space)
echo  %C_O%[4]%C_R% Reboot to Bootloader
echo %C_H%-----------------------------------------%C_R%
echo  %C_E%[99]%C_R% Back to Fastboot Menu
echo %C_H%=========================================%C_R%
set /p reb_choice="%C_O%Enter your choice:%C_R% "

if "%reb_choice%"=="1" goto FbOptReb1
if "%reb_choice%"=="2" goto FbOptReb2
if "%reb_choice%"=="3" goto FbOptReb3
if "%reb_choice%"=="4" goto FbOptReb4
if "%reb_choice%"=="99" goto FastbootMenu
goto FbRebootMenu
...
:: --- Sub-Menu: Flashing (Normal) ---
:FbFlashNormMenu
cls
echo %C_H%=========================================%C_R%
echo %C_T%        FLASHING MENU (NORMAL)          %C_R%
echo %C_H%=========================================%C_R%
echo  %C_O%[1]%C_R% Flash boot (Drag ^& Drop)
echo  %C_O%[2]%C_R% Flash init_boot (Drag ^& Drop)
echo  %C_O%[3]%C_R% Flash recovery (Drag ^& Drop)
echo  %C_O%[4]%C_R% Flash vbmeta (Drag ^& Drop)
echo %C_H%-----------------------------------------%C_R%
echo  %C_E%[99]%C_R% Back to Fastboot Menu
echo %C_H%=========================================%C_R%
set /p fn_choice="%C_O%Enter your choice:%C_R% "

if "%fn_choice%"=="1" set "p_name=boot" & goto ExecFlashNormal
if "%fn_choice%"=="2" set "p_name=init_boot" & goto ExecFlashNormal
if "%fn_choice%"=="3" set "p_name=recovery" & goto ExecFlashNormal
if "%fn_choice%"=="4" set "p_name=vbmeta" & goto ExecFlashVbmetaNormal
if "%fn_choice%"=="99" goto FastbootMenu
goto FbFlashNormMenu

:ExecFlashNormal
if not exist "%FASTBOOT%" goto MissingTools
cls
echo %C_H%===================================================%C_R%
echo %C_T%          FLASH %p_name% (Drag ^& Drop System)          %C_R%
echo %C_H%===================================================%C_R%
set /p img_file="%C_O%--> Drag and drop your %p_name% .img file here: %C_R%"
set img_file=%img_file:"=%
if not exist "%img_file%" echo %C_E%[!] File not found!%C_R% & pause & goto FbFlashNormMenu
echo %C_I%[*] Flashing %p_name%...%C_R%
"%FASTBOOT%" flash %p_name% "%img_file%"
echo %C_S%[~] Finished!%C_R%
pause & goto FbFlashNormMenu

:ExecFlashVbmetaNormal
if not exist "%FASTBOOT%" goto MissingTools
cls
echo %C_H%===================================================%C_R%
...
set img_file=%img_file:"=%
if not exist "%img_file%" echo %C_E%[!] File not found!%C_R% & pause & goto FbFlashNormMenu
echo %C_I%[*] Flashing vbmeta (Disabling Verity/Verification)...%C_R%
"%FASTBOOT%" --disable-verity --disable-verification flash vbmeta "%img_file%"
echo %C_S%[~] Finished!%C_R%
pause & goto FbFlashNormMenu


:: --- Sub-Menu: Flashing (A/B) ---
:FbFlashABMenu
cls
echo %C_H%=========================================%C_R%
echo %C_T%         FLASHING MENU (A/B SLOTS)        %C_R%
echo %C_H%=========================================%C_R%
echo  %C_O%[1]%C_R% Change Active Slot (A/B)
echo %C_H%-----------------------------------------%C_R%
echo  %C_O%[2]%C_R% Flash boot (Select Slot a/b)
echo  %C_O%[3]%C_R% Flash init_boot (Select Slot a/b)
echo  %C_O%[4]%C_R% Flash recovery (Select Slot a/b)
echo  %C_O%[5]%C_R% Flash vbmeta (Select Slot a/b)
echo %C_H%-----------------------------------------%C_R%
echo  %C_E%[99]%C_R% Back to Fastboot Menu
echo %C_H%=========================================%C_R%
set /p fab_choice="%C_O%Enter your choice:%C_R% "

if "%fab_choice%"=="1" goto FbOptChangeSlot
if "%fab_choice%"=="2" set "p_name=boot" & goto ExecFlashAB
if "%fab_choice%"=="3" set "p_name=init_boot" & goto ExecFlashAB
if "%fab_choice%"=="4" set "p_name=recovery" & goto ExecFlashAB
if "%fab_choice%"=="5" set "p_name=vbmeta" & goto ExecFlashVbmetaAB
if "%fab_choice%"=="99" goto FastbootMenu
goto FbFlashABMenu

:FbOptChangeSlot
if not exist "%FASTBOOT%" goto MissingTools
cls
set /p tgt_slot="%C_O%--> Enter slot to set active (a or b): %C_R%"
if /i not "%tgt_slot%"=="a" if /i not "%tgt_slot%"=="b" (
    echo %C_E%[!] Invalid slot! Please enter 'a' or 'b'.%C_R%
    pause & goto FbFlashABMenu
)
echo %C_I%[*] Changing active slot to '%tgt_slot%'...%C_R%
"%FASTBOOT%" set_active %tgt_slot%
pause & goto FbFlashABMenu
...
cls
echo %C_H%===================================================%C_R%
echo %C_T%      FLASH %p_name% [A/B] (Drag ^& Drop System)      %C_R%
echo %C_H%===================================================%C_R%
set /p img_file="%C_O%--> Drag and drop your %p_name% .img file here: %C_R%"
set img_file=%img_file:"=%
if not exist "%img_file%" echo %C_E%[!] File not found!%C_R% & pause & goto FbFlashABMenu
set /p slot_choice="%C_O%--> Enter slot (a or b) or press Enter for current slot: %C_R%"
set "final_part=%p_name%"
if /i "%slot_choice%"=="a" set "final_part=%p_name%_a"
if /i "%slot_choice%"=="b" set "final_part=%p_name%_b"
echo %C_I%[*] Flashing %final_part%...%C_R%
"%FASTBOOT%" flash %final_part% "%img_file%"
echo %C_S%[~] Finished!%C_R%
pause & goto FbFlashABMenu
...
cls
echo %C_H%===================================================%C_R%
echo %C_T%     FLASH VBMETA [A/B] (Drag ^& Drop System)       %C_R%
echo %C_H%===================================================%C_R%
set /p img_file="%C_O%--> Drag and drop your vbmeta .img file here: %C_R%"
set img_file=%img_file:"=%
if not exist "%img_file%" echo %C_E%[!] File not found!%C_R% & pause & goto FbFlashABMenu
set /p slot_choice="%C_O%--> Enter slot (a or b) or press Enter for current slot: %C_R%"
set "final_part=vbmeta"
if /i "%slot_choice%"=="a" set "final_part=vbmeta_a"
if /i "%slot_choice%"=="b" set "final_part=vbmeta_b"
echo %C_I%[*] Flashing %final_part% (Disabling Verity)...%C_R%
"%FASTBOOT%" --disable-verity --disable-verification flash %final_part% "%img_file%"
echo %C_S%[~] Finished!%C_R%
pause & goto FbFlashABMenu


:: --- Sub-Menu: Wipe Options ---
:FbWipeMenu
cls
echo %C_H%=========================================%C_R%
echo %C_T%           WIPE ^& ERASE MENU            %C_R%
echo %C_H%=========================================%C_R%
echo  %C_E%[1]%C_R% Factory Reset (fastboot -w)
echo  %C_E%[2]%C_R% Erase Userdata (fastboot erase userdata)
echo  %C_E%[3]%C_R% Erase FRP (fastboot erase frp)
echo %C_H%-----------------------------------------%C_R%
echo  %C_W%[99]%C_R% Back to Fastboot Menu
echo %C_H%=========================================%C_R%
set /p w_choice="%C_O%Enter your choice:%C_R% "

if "%w_choice%"=="1" goto FbOptWipe1
if "%w_choice%"=="2" goto FbOptWipe2
if "%w_choice%"=="3" goto FbOptWipe3
if "%w_choice%"=="99" goto FastbootMenu
goto FbWipeMenu
...
if /i not "%confirm%"=="Y" goto FbWipeMenu
echo %C_I%[*] Wiping data...%C_R%
"%FASTBOOT%" -w
pause & goto FbWipeMenu
